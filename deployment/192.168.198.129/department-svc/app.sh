...
PATH_TO_JAR=/opt/app/department-svc/lib/department-service-1.2-SNAPSHOT.jar
LOG_DIR=/opt/app/department-svc/logs/app.log
MAX_SIZE=10485760  # 10MB
PID_PATH_NAME=/opt/app/department-svc/application-pid

JAVA_HOME=/usr/lib/jvm/jdk-22+36
JAVA_CMD=$JAVA_HOME/bin/java

PROFILE=${2:-profile}         # Tham so 2: profile, mac dinh "profile"
LOGGING_FILE_SHELL=${3:-off}              # Tham so 3: bat/tat log, mac dinh "on"
