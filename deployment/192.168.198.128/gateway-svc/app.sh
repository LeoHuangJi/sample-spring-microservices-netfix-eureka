...
PATH_TO_JAR=/opt/app/gateway-svc/lib/gateway-service-1.1-SNAPSHOT.jar
LOG_DIR=/opt/app/gateway-svc/logs/app.log
MAX_SIZE=10485760  # 10MB (bytes)
PID_PATH_NAME=/opt/app/gateway-svc/application-pid
